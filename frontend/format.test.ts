...
describe("frontend format helpers", () => {
  ...
  test("formats timestamps in selected timezones and UTC", () => {
    ...
    expect(fmtDate("2024-07-01T00:00:00.000Z", "Europe/Berlin")).toMatch(/02:00:00.*(?:GMT\+2|CEST)/);
    expect(fmtDate("2024-01-01T00:00:00.000Z", "Europe/Berlin")).toMatch(/01:00:00.*(?:GMT\+1|CET)/);
