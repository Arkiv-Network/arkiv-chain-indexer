...
export const PARAMETERS: ParameterDef[] = [
  ...
  },
  {
    ...
    label: "Avg tx input data",
    axis: "avg-tx-input-data",
    axisLabel: "Avg tx input data",
    unit: "bytes",
    color: "#1f8a70",
    toNumber: plainNumber,
  },
  {
    ...
    label: "Avg tx input data zstd",
    axis: "avg-tx-input-data-zstd",
    axisLabel: "Avg tx input data zstd",
    unit: "bytes",
    color: "#0f766e",
    toNumber: plainNumber,
  },
